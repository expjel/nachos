...
public class KThread {
	...
	public static void finish() {
		...
		//wake the parent up if parent exists
	 ...
	 */
	 ...
	 //a.join() within thread b
	 //this = a, currentThread = b
	public void join() {
		...
		//if the thread to join is finished, just return
		//if(this.status != statusFinished)
		if(this.status != statusFinished){
			//sleep parent until child is finished
